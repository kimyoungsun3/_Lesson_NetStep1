...
namespace TimeServer13_Simple
{
	...
	class Program
	{
		...
		private void StartupServer(int _capability)
		{
	...
	class CUserToken
	{
		...
		//public void ClearSocket(){		socket = null;	}
		public int workNum;
		...
		public void SendMessage_Sending(int _debugWorkNum = -1)
		{
